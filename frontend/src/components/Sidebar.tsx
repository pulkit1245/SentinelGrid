...
import { Shield, LayoutDashboard, AlertTriangle, ClipboardList, MessageSquare, LogOut, User, Settings, Map, Radio } from 'lucide-react'
import { useAuth } from '../hooks/useAuth'

const NAV_ITEMS = [
  { to: '/dashboard',  icon: <LayoutDashboard size={16} />, label: 'Dashboard' },
  { to: '/sensor-map', icon: <Map size={16} />,             label: 'Sensor Map' },
  { to: '/black-box',  icon: <Radio size={16} />,           label: 'Black Box Replay' },
